 ...
 */
@Controller
public class PlanOwnerController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
		...
		this.idLibrary=myBean.getIdLibrary();
		loadDetails();	
    ...
    private void loadDetails(){
		planList.clear();
		planList.addAll(planService.findByUser_library_idLibrary(idLibrary));
